      ...
      <div class="row">  
        ...
        <div class="card-body">
   			 <form class="form-inline mb-3 pb-3" style="border-bottom:1px solid">
      			...
      			<input class="form-control form-control-sm mr-2 w-50" type="text" placeholder="Cerca utente" aria-label="Cerca utente">
				...
				<button type="button" class="btn btn-inline my-2 my-sm-0 mx-2 bg-warning " id="AddProposta"><i class="fas fa-plus-circle"></i></button>	
				 <select class="form-control form-group" id="inlineFormCustomSelectPref">
