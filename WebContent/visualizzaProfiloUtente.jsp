                            ...
                            <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <form action="ModificaProfiloUtenteServlet" method="post" name="modificaProfilo">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                 <input type="text" class="form-control" name="matricola" value="<%=utenteToShow.getMatricola()%>" required>
                                            </div>
                                        </div><% }%>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                 <input type="text" class="form-control" name="ufficio" value="<%=utenteToShow.getUfficio()%>" required>
                                            </div>
                                        </div><% }%>
