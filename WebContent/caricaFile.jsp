...
<body>
	...
	<div style="background-color: #FF9C08; min-height: 81vh;">
		...
		<div class="row">
			<div class="col-md-8 my-4">
				<div class="card mb-3">
					<div class="card-body " style="min-height: 80vh;">
						...
						<div class="form-inline mb-3 pb-3"
							style="border-bottom: 1px solid">
							<h5 class="card-title mb-1">Gestione Area&nbsp;</h5>
						</div>
									...
									<div class="profile-head">
										<ul class="nav nav-tabs" id="myTab" role="tablist">
											<li class="nav-item"><a class="nav-link active"
												...
												aria-controls="home" aria-selected="true">Carica File</a></li>

											<li class="nav-item"><a class="nav-link"
												id="profile-tab" data-toggle="tab" href="#profile"
												role="tab" aria-controls="profile" aria-selected="false">Aggiungi
													Consegna</a></li>
										</ul>
									</div>
								</div>
								...
								<div class="col-md-8">
									<div class="tab-content profile-tab" id="myTabContent">
											...
											<form action="CaricaFileServlet" method="post"
												...
												<div class="form-group">
													<label for="nomeFile"><b>Nome File:</b></label> <input
														...
														onchange="controlloNome()" name="nomeFile" required>
												</div>
												<div class="form-group">
													<label for="descrizioneFile"><b>Descrizione:</b></label>
													<textarea class="form-control"
														onchange="controlloDescrizione()" name="descrizioneFile"
										...
										<div class="tab-pane fade" id="profile" role="tabpanel"
											...
											<form action="AggiungiConsegnaServlet" method="post" name="caricaConsegna">
												<div class="form-group">
												...
												<div class="form-group">
													<label for="descrizioneConsegna"><b>Descrizione:</b></label>
													<textarea class="form-control"
														onchange="controlloDescrizioneConsegna()" name="descrizioneConsegna"
														rows="4" required></textarea>
												</div>
			...
			<div class="p-3 card" style="min-height: 81vh;">
				<%
