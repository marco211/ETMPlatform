	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col my-4 mx-4">
				<h1>Recupero password non riuscito</h1>
				<h6>Nessun account associato all'indirizzo e-mail specificato</h6>
				<h6>
					<a href="http://localhost:8080/ETMPlatform/index.jsp">Torna alla home</a>
				</h6>
			</div>
		</div>
	</div>
