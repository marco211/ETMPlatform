 ...
 * la lista delle proposte tesi attive sia del docente che per lo studente.
 */
...
public class ListaProposteTesiAttiveServlet extends HttpServlet {
  ...
  /**
   * Restituisce tutte le richieste di proposte di tesi: se 
   * l'utente e un docente restituisce tutte le richieste
   * effettuate da parte degli studenti, se l'utente e uno 
   * studente restituisce tutte le richieste effettuate.
   */
