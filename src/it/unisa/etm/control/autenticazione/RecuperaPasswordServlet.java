 ...
 * all'utente la funzionalita di poter recuperare la sua password.
 */
  ...
  public static boolean send(String ricevente, String testo) {
    ...
    try {
      ...
      msg.setContent("<html>\r\n"
          ...
          + "Password: \"" + testo + "\".<br>" 
          + "Le ricordiamo che e possibile cambiare la password una volta effettuato "
          + "l'accesso con il vostro account all'apposita sezione.<br>" 
          + "Cordiali saluti.<br>" 
          + "\r\n" 
          + "</body>\r\n" 
          + "</html>", "text/html"); 
