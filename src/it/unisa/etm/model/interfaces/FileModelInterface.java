...
/**
 * Metodi dedicati alle operazioni svolte sui 
 * file da parte degli utenti di un'area privata condivisa.
 * @author ETM
 *
 */
public interface FileModelInterface {
   ...
   * @param idTesi identificativo della proposta di  
   *     tesi per la quale e attiva l'area privata condivisa.
   ...
   * @param idTesi identificativo della proposta di 
   *     tesi per la quale e attiva l'area privata condivisa.
   * @return lista di oggetti File che rappresentano i  
   *     file presenti nell'area privata condivisa, in caso di successo.
   ...
   * @param idTesi identificativo della proposta 
   *     di tesi per la quale e attiva l'area privata condivisa.
