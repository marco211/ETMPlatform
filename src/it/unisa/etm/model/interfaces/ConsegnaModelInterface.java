...
public interface ConsegnaModelInterface {
  /**
   * Aggiunge una consegna, creata da parte di 
   * un utente registrato come docente, all'area privata condivisa.
  ...
  /**
   * Effettua la modifica da parte del docente 
   * di una consegna da lui creata nell'area privata condivisa.
  ...
  /**
   * Si occupa dell'eliminazione, da parte di un 
   * docente, di una consegna creata da lui in precedenza.
   ...
   * @param propostaTesiId identificativo della proposta 
   *     tesi per la quale � attiva l'area privata condivisa.
   * @return ArrayList di oggetti Consegna che rappresenta 
   *     tutte le consegne presenti nell'area privata condivisa, in caso di successo.
