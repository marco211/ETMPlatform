...
public interface PropostaTesiModelInterface {
  /**
   * Si occupa dell'accettazione, da parte di un utente registrato come docente, 
   * di una richiesta di partecipazione effettuata da un utente registrato come studente.
  ...
  /**
   * Si occupa del rifiuto, da parte di un utente registrato come docente, 
   * di una richiesta di partecipazione effettuata da un utente registrato come studente.
   * @param id identificativo della richiesta di partecipazione.
  ...
  /**
   * Si occupa della ricerca di richieste di partecipazione per 
   * le proposte di tesi di un determenato utente registrato come docente.
   * @param email Stringa dell'utente registrato come docente.
   * @return ArrayList di richieste di oggetti RichiestaPartecipazione 
   *      che rappresentano le richieste di partecipazione, in caso di successo;
   ...
   * @return un oggetto PropostaTesi che rappresenta 
   *      la proposta di tesi desiderata, in caso di successo;
   *      null in caso d'insuccesso.
   */
  public PropostaTesi getPropostaTesi(int id);

  /**
   * Si occupa della rimozione di una proposta di tesi, effettuata da un utente 
   * registrato come docente per una proposta di tesi creata da lui in precedenza.
  ...
  /**
   * Salva in memoria una richiesta di partecipazione per una determinata 
   * proposta di tesi, da parte di un utente registrato come docente.
  ...
  /**
   * Si occupa dell'archiviazione di una proposta di tesi, effettuata da un utente
   *  registrato come docente per una proposta di tesi creata da lui in precedenza.
  ...
  /**
   * Si occupa della chiusura di una proposta di tesi, effettuata da un utente registrato 
   * come docente per una proposta di tesi creata da lui in precedenza.
   ...
   * @return ArrayList di oggetti PropostaTesi che 
   *      rappresentano le proposte di tesi attive, in caso di successo;
   ...
   * @return ArrayList di oggetti PropostaTesi che rappresentano le proposte 
   *     di tesi create dall'utente registrate come docente, in caso di successo.
   *     null se l'utente non ha proposte di tesi attualmente 
   *     registrate nella piattaforma, o in caso d'insuccesso.
   */
  public ArrayList<PropostaTesi> getProposteTesiDocente(String utenteEmail);

  /**
   * Si occupa della modifica, da parte di un utente 
   * registrato come docente, di una propria proposta di tesi.
   ...
   * @param utenteEmail email dell'utente registrato 
   *     come studente per il quale cercare le richieste.
   * @return ArrayList di oggetti RichiestaPartecipazione che rappresentano le 
   *     richieste di partecipazione dell'utente registrato come studente, in caso di successo;
   ...
   * @return ArrayList di oggetti Insegnamento che rappresentano 
   *     gli insegnamenti presenti nella piattaforma, in caso di successo;
   ...
   * @return ArrayList di oggetti PropostaTesi che rappresentano 
   *     le ultime 8 tesi inserite nella piattaforma, in caso di successo;
