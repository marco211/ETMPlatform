...
public class TestFile {
  private static File fileOk;
  private static File fileNotOk;
  ...
  public void testGetDescrizione() {
    ...
    //descrzione sbagliata, la descrizione giusta e descrizione2
    descrizione = fileNotOk.getDescrizione();
    assertNotEquals(descrizione,"descrizione3");
  }
  ...
  public void testGetDescrizioneVoto() {
    ...
    //descrizione voto sbagliata, la descrizione voto giusta e descrizione voto2
    descrizione = fileNotOk.getDescrizioneVoto();
    assertNotEquals(descrizione,"descrizione voto3"); 
  }
